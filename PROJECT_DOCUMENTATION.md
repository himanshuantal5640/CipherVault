...
MONGODB_URI=mongodb+srv://YOUR_USER:YOUR_PASS@YOUR_CLUSTER.mongodb.net/ciphervault
JWT_SECRET=YOUR_SECURE_64_CHARACTER_RANDOM_SECRET_KEY
JWT_EXPIRES_IN=1d
CLIENT_URL=http://localhost:5173
AWS_REGION=ap-south-1
AWS_ACCESS_KEY_ID=YOUR_AWS_ACCESS_KEY_ID
AWS_SECRET_ACCESS_KEY=YOUR_AWS_SECRET_ACCESS_KEY
AWS_S3_BUCKET=ciphervault-secure-files-2026-ha
